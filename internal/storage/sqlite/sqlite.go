...
func (s *Storage) IsAdmin(context context.Context, userID int64) (bool, error) {
	...
	row := stmt.QueryRowContext(context, userID)
	var isAdmin bool
...
func (s *Storage) App(context context.Context, appID int) (models.App, error) {
	...
	row := stmt.QueryRowContext(context, appID)
	var app models.App
